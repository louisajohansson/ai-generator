...
function generateAnswer(event) {
  ...
  let context = "You are a masterquoter AI assistent who knows all the best quotes in the world. Give the best quote using the users instructions. The quote shouldn't be more than three lines and seperated by <br />. Sign if the name of the person you quoted. No offensive and very sweet and kind quotes";
